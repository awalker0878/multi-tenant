...
<!-- SOURCE-BLOCK RA:198 BEGIN -->

<a id="__RefHeading___Toc3664_865363315"></a>
<a id="RA_s_013"></a>

<!-- SOURCE-BLOCK RA:198 END -->

<!-- SOURCE-BLOCK RA:199 BEGIN -->
...
<!-- SOURCE-BLOCK RA:199 END -->

<!-- SOURCE-BLOCK RA:200 BEGIN -->
...
<!-- SOURCE-BLOCK RA:200 END -->

<!-- SOURCE-BLOCK RA:201 BEGIN -->
...
<!-- SOURCE-BLOCK RA:201 END -->

<!-- SOURCE-BLOCK RA:202 BEGIN -->

<!-- SOURCE-BLOCK RA:202 END -->

<!-- SOURCE-BLOCK RA:203 BEGIN -->
...
<!-- SOURCE-BLOCK RA:203 END -->

<!-- SOURCE-BLOCK RA:204 BEGIN -->
...
<!-- SOURCE-BLOCK RA:204 END -->

<!-- SOURCE-BLOCK RA:205 BEGIN -->
...
<!-- SOURCE-BLOCK RA:205 END -->

<!-- SOURCE-BLOCK RA:206 BEGIN -->
...
<!-- SOURCE-BLOCK RA:206 END -->

<!-- SOURCE-BLOCK RA:207 BEGIN -->
...
<!-- SOURCE-BLOCK RA:207 END -->

<!-- SOURCE-BLOCK RA:208 BEGIN -->
...
- [ADR-0037 — Keep attributable telemetry independent and define collection-loss behaviour](../../adr/0037-keep-attributable-telemetry-independent-and-define-collection-loss-behaviour.md)
