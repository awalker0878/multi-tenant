# 4. Use working records without creating duplicate truth
...
| Material | Version / role | How to use it |
| --- | --- | --- |
| 05\_Reference\_v1\_4 | Eight frozen parent documents and reference registers. | Read and cite; record variations separately. |
