# 9. Build and qualification design
...
| --- | --- | --- |
| Method of procedure | Site-specific steps, targets, current prerequisites and expected results. | {{ET\_MOP}} |
| Safe stop/recovery | Abort thresholds, rollback/data boundaries, forward repair and late-task discovery. | {{ET\_ROLLBACK}} |
| Test campaign | Requirements/assertions, approved fixture, family/topology coverage and expected observations. | {{ET\_TESTS}} |
| Test resources | Temporary probes, failure fixtures, load, spare capacity and safety/restoration plan. | {{ET\_TEST\_RES}} |
