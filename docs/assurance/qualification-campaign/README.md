...
[Documentation home](../../README.md) · [Source document](../../../reference/Portable_Hosting_Delivery_Kits_v1_1/03_Implementation/Qualification_Campaign_and_Evidence_Procedures.docx)
...
- [1. Select the qualification scope and acceptance claim](1-select-the-qualification-scope-and-acceptance-claim.md)
- [2. Size and control the qualification fixture](2-size-and-control-the-qualification-fixture.md)
- [3. Observe network paths and boundary enforcement](3-observe-network-paths-and-boundary-enforcement.md)
- [4. Observe identity, storage and protocol completeness](4-observe-identity-storage-and-protocol-completeness.md)
- [5. Separate safe failure, service continuity and recovery](5-separate-safe-failure-service-continuity-and-recovery.md)
- [6. Build an evidence packet a reviewer can challenge](6-build-an-evidence-packet-a-reviewer-can-challenge.md)
- [7. Compare vendor realizations without assuming migration](7-compare-vendor-realizations-without-assuming-migration.md)
