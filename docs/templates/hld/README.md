...
[Documentation home](../../README.md) · [Source document](../../../reference/Portable_Hosting_Delivery_Kits_v1_1/01_Architecture/HLD_and_Architecture_Review_Template.docx)
...
- [1. Mandate and service envelope](1-mandate-and-service-envelope.md)
- [2. Requirements and applicability](2-requirements-and-applicability.md)
- [3. Context and physical deployment views](3-context-and-physical-deployment-views.md)
- [4. Logical tenancy, security and traffic views](4-logical-tenancy-security-and-traffic-views.md)
- [5. Management, data and service dependencies](5-management-data-and-service-dependencies.md)
- [6. Architecture decision record](6-architecture-decision-record.md)
- [7. Threat, sharing and responsibility review](7-threat-sharing-and-responsibility-review.md)
- [8. Reliability, capacity and exit design](8-reliability-capacity-and-exit-design.md)
- [9. Vendor realization and provisioning strategy](9-vendor-realization-and-provisioning-strategy.md)
