...
| --- | --- | --- |
| Decision identity | ID, scope, status and version of the decision. | {{AT\_ADR\_ID}} |
| Problem/constraints | Why this choice is needed and affected baseline requirements. | {{AT\_ADR\_CONTEXT}} |
| Alternatives | Viable mechanisms and rejection rationale, not a vendor popularity ranking. | {{AT\_ADR\_OPTIONS}} |
| Proposed selection | Chosen topology/control placement and conditions of use. | {{AT\_ADR\_CHOICE}} |
| Consequences | Risks, capacity/cost, management, recovery, support and portability. | {{AT\_ADR\_EFFECT}} |
