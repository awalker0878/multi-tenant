...
| --- | --- | --- |
| Review scope | HLD revision, drawings, requirement/decision register snapshots and reviewer roles. | {{AT\_REVIEW}} |
| Review findings | Blocking items and accepted dispositions with owners and evidence. | {{AT\_FINDINGS}} |
| Engineering inputs | Actual decisions delegated to LLD, records required and boundary constraints. | {{AT\_HANDOFF}} |
| Adoption decision | Actual G0 decision/reference, authority, date and limited scope. | {{AT\_G0}} |
