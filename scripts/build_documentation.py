...
''')
    ...
    def code_map(self):
        ...
        text+=['## Platform capability registry','',
          ...
          'Design: '+self.link(p,'docs/assurance/gap-map/3-detailed-gap-register-and-treatment.md#gap_G30','G30 control inheritance gap')+' · '+self.link(p,'docs/assurance/site-qualification/6-control-inheritance-assurance-and-organizational-interfaces.md','Control inheritance and organizational interfaces')+' · '+self.link(p,'docs/architecture/reference/28-architecture-acceptance-and-verification.md','Architecture acceptance and verification'), '',
