...
<!-- SOURCE-BLOCK WDE:41 BEGIN -->

<a id="EX_04"></a>

<!-- SOURCE-BLOCK WDE:41 END -->

<!-- SOURCE-BLOCK WDE:42 BEGIN -->

The architecture identifiers remain stable while the selected stack supplies native components and operation semantics.

<!-- SOURCE-BLOCK WDE:42 END -->

<!-- SOURCE-BLOCK WDE:43 BEGIN -->
...
<!-- SOURCE-BLOCK WDE:43 END -->

<!-- SOURCE-BLOCK WDE:44 BEGIN -->
...
<!-- SOURCE-BLOCK WDE:44 END -->

<!-- SOURCE-BLOCK WDE:45 BEGIN -->

<!-- SOURCE-BLOCK WDE:45 END -->

<!-- SOURCE-BLOCK WDE:46 BEGIN -->
...
<!-- SOURCE-BLOCK WDE:46 END -->

<!-- SOURCE-BLOCK WDE:47 BEGIN -->
...
<!-- SOURCE-BLOCK WDE:47 END -->

<!-- SOURCE-BLOCK WDE:48 BEGIN -->

<!-- SOURCE-BLOCK WDE:48 END -->
