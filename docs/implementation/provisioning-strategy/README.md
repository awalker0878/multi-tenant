...
## Source front matter
<!-- SOURCE-BLOCK PROV:0 BEGIN -->

<a id="V14_PROV_START"></a>

INFRASTRUCTURE ARCHITECTURE  /  PROV

<!-- SOURCE-BLOCK PROV:0 END -->

<!-- SOURCE-BLOCK PROV:1 BEGIN -->
...
<!-- SOURCE-BLOCK PROV:1 END -->

<!-- SOURCE-BLOCK PROV:2 BEGIN -->

## Portable Multi-Tenant<br>Secure Hosting

<!-- SOURCE-BLOCK PROV:2 END -->

<!-- SOURCE-BLOCK PROV:3 BEGIN -->

*Cross-Stack Provisioning and Commissioning Strategy*

<!-- SOURCE-BLOCK PROV:3 END -->

<!-- SOURCE-BLOCK PROV:4 BEGIN -->

Draft v1.4  \|  16 September 2026

<!-- SOURCE-BLOCK PROV:4 END -->

<!-- SOURCE-BLOCK PROV:5 BEGIN -->
...
<!-- SOURCE-BLOCK PROV:5 END -->

<!-- SOURCE-BLOCK PROV:6 BEGIN -->
...
<!-- SOURCE-BLOCK PROV:6 END -->

<!-- SOURCE-BLOCK PROV:7 BEGIN -->

<!-- SOURCE-BLOCK PROV:7 END -->

<!-- SOURCE-BLOCK PROV:8 BEGIN -->
...
<!-- SOURCE-BLOCK PROV:8 END -->

<!-- SOURCE-BLOCK PROV:9 BEGIN -->
...
<!-- SOURCE-BLOCK PROV:9 END -->

<!-- SOURCE-BLOCK PROV:10 BEGIN -->

<!-- SOURCE-BLOCK PROV:10 END -->

<a id="PROV_contents"></a>

<!-- SOURCE-BLOCK PROV:20 BEGIN -->

<!-- SOURCE-BLOCK PROV:20 END -->

<!-- SOURCE-BLOCK PROV:21 BEGIN -->
...
<!-- SOURCE-BLOCK PROV:21 END -->

<!-- SOURCE-BLOCK PROV:22 BEGIN -->

<!-- SOURCE-BLOCK PROV:22 END -->
