...
class NavigationIntegrationTests(unittest.TestCase):
    ...
    def test_address_family_navigation_survives_regeneration(self):
        text = self.navigation()['docs/engineering/README.md']
    ...
    def test_planning_and_task_campaign_ci_steps_coexist(self):
        ...
        self.assertTrue(any('scripts/check_address_family_assurance.py' in s for s in commands))
        self.assertTrue(any('scripts/check_address_family_readiness.py' in s for s in commands))
