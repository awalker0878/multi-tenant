# 39. Logging, Telemetry, and Observability
...
| Telemetry Source | Minimum Questions It Should Answer |
| --- | --- |
| Security edge | Which domain-to-domain flow was allowed/denied, by which policy, and when? |
| Platform network | Which endpoint/identity originated or received traffic? |
| Terraform/CI | Who requested/applied which desired-state change? |
| Route Authority | Why is this prefix or default route present? |
