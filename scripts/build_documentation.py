...
''')
    ...
    def category(self,path,title,intro,ids,extra=()):
    ...
    def navigation(self):
        ...
        self.category('docs/engineering/README.md','Engineering',
          ...
          [('docs/engineering/TAD.md','TAD — Technical architecture reading view'),('docs/templates/lld/README.md','Editable low-level design template')])
        ...
        self.category('docs/implementation/README.md','Implementation and commissioning',
          ...
          [('docs/implementation/code-map.md','Architecture / decision / implementation map'),('docs/templates/implementation-mop/README.md','Method-of-procedure and handover templates'),('docs/COMMISSIONING.md','Existing executable commissioning procedure')])
