# 1. Design identity, scope and baseline
...
| --- | --- | --- |
| Design identity | Site/service ID, LLD version and author/reviewer roles. | {{ET\_ID}} |
| Approved parent | HLD, G0 decision, reference version and accepted variations. | {{ET\_PARENT}} |
| Scope and stages | New site, extension, adoption or tenant change; selected P0–P6 work. | {{ET\_SCOPE}} |
| Controlled schedules | Workbook and artifact repository version/digest. | {{ET\_SCHEDULES}} |
